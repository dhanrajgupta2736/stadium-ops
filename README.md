...
### 1. Zone simulation (`useZoneSimulation`)
...
### 2. Context-aware directive engine (`directiveRules.js` + `useDirectiveFeed`)
...
### 3. Dispatch actions with real feedback loops (`useDispatchActions`)
...
### 4. Multi-language incident reporting (`useIncidentLog`, `useIncidentForm`)
